...
spa.shell = (function () {
    ...
    //  * false - slider activation not activated
        ...
        if (do_extend) {
            jqueryMap.$chat.animate(
                ...
                function () {
                    ...
                    if (callback) { // check if there is a callback function to be called after animation is complete  
    ...
    // Returns: boolean
    //  * true - The Anchor portion was updated
